...
type SystemSettings struct {
	...
	General *SystemSettingsGeneral `json:"general,omitempty"`

	Integration *SystemSettingsIntegration `json:"integration,omitempty"`

	Notification *SystemSettingsNotification `json:"notification,omitempty"`

	Maintenance *SystemSettingsMaintenance `json:"maintenance,omitempty"`
}
